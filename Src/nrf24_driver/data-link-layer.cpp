...
NRF_DATA_LINK_LAYER::NRF_DATA_LINK_LAYER(SPI_TypeDef* spi_instance, GPIO_TypeDef* ce_port, uint16_t ce_pin):
spiInstance{spi_instance}, cePort{CE}, cePin{GPIO_PIN}
{}
